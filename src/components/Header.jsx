      ...
      <header>
        <div className="top-0 left-0 right-0 flex justify-between items-center h-24 w-screen px-5 text-white ">
          ...
          <div className="flex w-100 items-center">
            ...
            >
              {!dark && <IoIosSunny size={18} className="dark:text-primary-color  dark:hover:text-white" />}
              {dark && <IoIosMoon size={18} className="dark:text-primary-color  dark:hover:text-white" />}
            </button>
